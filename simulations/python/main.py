    ...
    if len(sys.argv) != 30: 
        ...
        if input_pcap_range_enabled == "False":
            ...
            for file_id in range(input_pcap_range_init, input_pcap_range_end):
                if file_id == 0:
                    file_name = '/euler/CICDDoS2019/data/SAT-01-12-2018_0'
                else:
                    file_name = '/euler/CICDDoS2019/data/SAT-01-12-2018_0' + str(file_id)
        ...
        if clustering_performance_logging == "True":
            ...
            for file_name in input_pcap_list:
                file_id = file_name.split('/euler/CICDDoS2019/data/SAT-01-12-2018_0')[1]
