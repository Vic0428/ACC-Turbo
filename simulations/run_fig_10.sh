...
rm python/plots/num_clusters/clustering_performance_logs.dat
touch python/plots/num_clusters/clustering_performance_logs.dat
##############################################
...
CLUSTERING_TYPE="Online_Epoch_KMeans"
